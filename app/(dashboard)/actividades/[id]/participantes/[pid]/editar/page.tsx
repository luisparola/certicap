        ...
        <Card className="glass-card border-white/10">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="space-y-2"><Label className="text-gray-300">Nota Teoria</Label><Input type="number" step="0.1" min="1" max="7" value={form.nota_teoria} onChange={(e) => handleChange("nota_teoria", e.target.value)} className="bg-[#0F0F0F] border-white/10 text-white" /></div>
              <div className="space-y-2"><Label className="text-gray-300">Nota Practica</Label><Input type="number" step="0.1" min="1" max="7" value={form.nota_practica} onChange={(e) => handleChange("nota_practica", e.target.value)} className="bg-[#0F0F0F] border-white/10 text-white" /></div>
