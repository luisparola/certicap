    ...
    fetch(`/api/actividades/${params.id}`)
      ...
      .then((d) => {
        setForm({
          ...
          fecha_inicio: toDateInput(d.fecha_inicio),
          fecha_termino: toDateInput(d.fecha_termino),
          lugar: d.lugar ?? "",
          instructor: d.instructor ?? "",
          empresa_nombre: d.empresa_nombre ?? "",
          empresa_rut: d.empresa_rut ?? "",
          observaciones: d.observaciones ?? "",
        })
      })
      .catch(() => toast({ variant: "destructive", title: "Error", description: "No se pudo cargar la actividad." }))
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 animate-fade-in">
      <div className="flex items-center gap-4">
        ...
        <div><h1 className="text-2xl font-bold text-white">Editar Actividad</h1><p className="text-gray-400 mt-1">Modifica los datos del curso o capacitacion</p></div>
      </div>
